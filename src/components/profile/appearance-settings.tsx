...
/** Website customization — theme mode, accent color and corner radius. */
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-bold">Customize the website</h2>
          <p className="text-sm text-muted-foreground">
            Saved instantly and remembered on this device.
          </p>
        </div>
